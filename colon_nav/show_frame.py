...
from colon_nav.visuals.plots_2d import draw_track_box_on_frame
...
def main():
    ...
    parser.add_argument(
        "--scene_path",
        type=str,
        default="data_gcp/datasets/ColonNav/Test/Scene_00000/Test/Target_Cases/Case_0000",
        help="Path to the scene folder",
    )
    parser.add_argument(
        "--save_path",
        type=str,
        default="data/results/ColonNav/plot_example_frame",
