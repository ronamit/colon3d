...
from colon_nav.util.general_util import bool_arg
...
class MonoDepth2Options(GeneralOptions):
    def __init__(self) -> None:
        ...
        self.parser.add_argument("--use_stereo", type=bool_arg, help="if set, uses stereo pair for training", default=False)
...
# --------------------------------------------------------------------------------------------------------------------
class StereoDepthOptions(GeneralOptions):
    def __init__(self) -> None:
        super().__init__()
        self.parser = argparse.ArgumentParser(description="StereoDepth2 options")
        # PATHS
        self.parser.add_argument(
            "--data_path",
            type=str,
        ...
        self.parser.add_argument("--min_depth", type=float, help="minimum depth", default=0.1)
        self.parser.add_argument("--max_depth", type=float, help="maximum depth", default=100.0)
        self.parser.add_argument("--use_stereo", type=bool_arg, help="if set, uses stereo pair for training", default=True)
