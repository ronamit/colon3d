...
def main():
    ...
    parser.add_argument(
        "--raw_sim_data_path",
        type=str,
        default="data_gcp/raw_datasets/SimCol3D",  #  ColonNav/TrainData | ColonNav/TestData| SimCol3D |
        help="The path to the folder with the raw simulated scenes to load (generated by Unity).",
    )
    parser.add_argument(
        "--path_to_save_data",
        type=str,
        default="data/datasets/SimCol3D/test",  #  ColonNav/TrainData | ColonNav/TestData | SimCol3D/train | SimCol3D/test
