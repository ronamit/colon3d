"""
Source: https://github.com/ESandML/FCBFormer/blob/main/Models/models.py
...
from colon3d.net_train import pvt_v2
...
class TB(nn.Module):
    ...
    def forward(self, x):
        ...
        pyramid_emph = []
        for i, _level in enumerate(pyramid):
