...
class AlgorithmParam:
    ...
    max_vel: float = 300  # mm/s
    max_angular_vel: float = 3 * np.pi  # rad/s
    ...
    w_p3d_change : float = 1e-7  # default weighting for the penalty term of the change in the 3D points in the bundle adjustment cost function
    w_lim_vel: float = 1e-3  # default weighting for the max-velocity penalty term in the bundle adjustment cost function
    w_lim_angular_vel: float = 1e-3 # default weighting for the max-angular-velocity penalty term in the bundle adjustment cost function
    ...
    z_depth_default: float = 5  # default z-depth estimation, when no other data is available (units: mm)
