...
class AlgorithmParam:
    ...
    w_lim_vel: float = 1e-2  # default weighting for the max-velocity penalty term in the bundle adjustment cost function
    w_lim_angular_vel: float = 1e-2 # default weighting for the max-angular-velocity penalty term in the bundle adjustment cost function
