...
class AlgorithmParam:
    ...
    w_p3d_change : float = 1e-6  # default weighting for the penalty term of the change in the 3D points in the bundle adjustment cost function
    w_lim_vel: float = 1e-5  # default weighting for the max-velocity penalty term in the bundle adjustment cost function
    w_lim_angular_vel: float = 1e-5 # default weighting for the max-angular-velocity penalty term in the bundle adjustment cost function
