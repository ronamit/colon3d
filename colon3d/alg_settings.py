...
class AlgorithmParam:
    ...
    max_angular_vel: float = 1.5 * np.pi  # rad/s
    ...
    w_cam_trans: float = 1e-7  # default weighting for the penalty term of the l2 norm of the camera translation (from previous frame) in the bundle adjustment cost function
    w_cam_rot: float = 1e-7  # default weighting for the penalty term of the camera rotation (from previous frame) in the bundle adjustment cost function
    w_lim_vel: float = 1e-7  # default weighting for the max-velocity penalty term in the bundle adjustment cost function
    w_lim_angular_vel: float = 1e-7 # default weighting for the max-angular-velocity penalty term in the bundle adjustment cost function
    ...
    z_depth_default: float = 10  # default z-depth estimation, when no other data is available (units: mm)
    ...
    opt_max_iter: int = 20  # maximum number of iterations for the optimization
