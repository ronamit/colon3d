...
import sc_depth.losses.loss_functions as LossF
from sc_depth.models.DepthNet import DepthNet
from sc_depth.models.PoseNet import PoseNet
from sc_depth.visualization import visualize_depth, visualize_image
...
class SC_DepthV3(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_1, loss_2, dynamic_mask = LossF.photo_and_geometry_loss(
            tgt_img,
            ref_imgs,
            tgt_depth,
            ref_depths,
    ...
    def validation_step(self, batch, batch_idx):
        if self.hparams.hparams.val_mode == "depth":
            ...
            loss_1, _, _ = LossF.photo_and_geometry_loss(
                tgt_img,
                ref_imgs,
                tgt_depth,
                ref_depths,
        ...
        if batch_idx < 3:
            ...
            self.logger.experiment.add_images(f"val/img_depth_{batch_idx}", stack, self.current_epoch)
