...
from sc_depth.models.RectifyNet import RectifyNet
...
class SC_DepthV2(LightningModule):
    ...
    def rectify_imgs(self, tgt_img, ref_imgs, intrinsics):
        ...
        for ref_img in ref_imgs:
            ...
            if rot1.abs().mean() > 0.02 and rot1.abs().mean() < 0.1:
                ...
                warp_ref_img = inverse_rotation_warp(ref_img, rot3_gt, intrinsics)
    ...
    def training_step(self, batch, batch_idx):
        ...
        ref_imgs_warped, loss_rc, loss_rt, rot_before, rot_after = self.rectify_imgs(tgt_img, ref_imgs, intrinsics)
