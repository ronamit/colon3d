...
from sc_depth.config import get_training_size
...
class VideosDataModule(LightningDataModule):
    def __init__(self, hparams):
        ...
        self.load_pseudo_depth = hparams.model_version == "v3"
    ...
    def setup(self, stage=None):
        ...
        print(f"{len(self.train_dataset)} samples found for training")
        print(f"{len(self.val_dataset)} samples found for validation")
